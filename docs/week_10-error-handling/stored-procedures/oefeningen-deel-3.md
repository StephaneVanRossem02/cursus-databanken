---
title: "Oefeningen error handling"
...
In de uitleg rond [`SIGNAL`](/docs/week_10-error-handling/stored-procedures/signal) vind je een link naar de officiële MySQL documentatie. Deze kan je gebruiken om de gepaste MySQL codes en SQL states op te zoeken.
...
Pas je handler voor de fouten '45001' en '45003' aan zodat er geen `SELECT` meer plaatsvindt. In de plaats daarvan wordt het `MESSAGE_TEXT` attribuut van het signaal aangepast naar `'Ik heb mijn best gedaan!'` en wordt de fout verder niet afgehandeld. Zie hiervoor [`RESIGNAL`](/docs/week_10-error-handling/stored-procedures/resignal).

Schrijf hiervoor een script, `0649__Oefening.sql`.

## Vraag 3

Pas de procedure [VoorbeeldCursors](/docs/week_11-transactions/stored-procedures/cursors) aan zodat de genres gescheiden worden door een komma en zodat er géén komma na het laatste genre staat. Hierbij mag je de volgorde waarin de genres getoond worden wijzigen indien nodig, maar ze moeten er allemaal wel blijven staan.
...
![](/img/databanken/Screenshot_from_2021-05-04_16-17-58.png)
...
![Voorbeelduitvoer van een call van de procedure](/img/databanken/Screenshot_from_2021-05-04_16-28-54.png)
