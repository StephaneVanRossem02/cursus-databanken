...
De `WHILE`-lus controleert de conditie voordat het statement wordt uitgevoerd.

Onderstaand schema illustreert dit principe.

![](/img/databanken/sp_while.JPG)
...
![](/img/databanken/Screenshot_from_2023-02-23_14-30-50.png)
