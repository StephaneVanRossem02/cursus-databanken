...
![De function editor vind je op dezelfde manier terug als de procedure editor](/img/databanken/function-editor.png)
...
![](/img/databanken/deterministische-functie.png)

Een voorbeeld van een niet-deterministische functie:

![](/img/databanken/niet-deterministische-functie.png)
