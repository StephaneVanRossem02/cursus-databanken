...
![Eén taak hoort bij één lid (en dus ook omgekeerd).](/img/databanken/taken_leden_bewerkt.png)
...
![Eén user kan meerdere tweets hebben, elke tweet komt van exact één user.](/img/databanken/Screenshot_from_2020-11-21_10-05-24.png)
...
Hoe je de tweets terug koppelt aan de juiste account, lees je ook bij de uitleg rond [`JOIN`-operaties bij simpele relaties](/docs/week_05-joins/joins-basic/joins-simpele-relaties). We tonen hier alleen dat het mogelijk is. Koppel users aan de juiste tweets met dit script, 0058\_\_SelectUsersTweets.sql:
...
![Diagram voor een veel-op-veel relatie. Je tekent deze als twee één-op-veel relaties.](/img/databanken/Screenshot_from_2020-11-21_10-15-27.png)
...
[`JOIN`-operaties bij simpele relaties](/docs/week_05-joins/joins-basic/joins-via-tussenliggende-tabel) legt uit hoe je nu toont welke games op welk platform verschenen zijn. Dit wordt hier gedaan in 0061\_\_SelectReleases.sql:
...
| Anthem                    | XBox One        | 03 maart 2019     |
| Anthem                    | Windows         | 05 april 2019     |
| Sekiro: Shadows Die Twice | PS4             | 22 maart 2019     |
| Sekiro: Shadows Die Twice | XBox One        | 01 mei 2019       |
| Sekiro: Shadows Die Twice | Windows         | 10 april 2019     |
| Devil May Cry 5           | PS4             | 08 maart 2019     |
| Devil May Cry 5           | XBox One        | 01 februari 2019  |
| Mega Man 11               | PS4             | 02 oktober 2018   |
| Mega Man 11               | XBox One        | 15 september 2018 |
| Mega Man 11               | Windows         | 20 augustus 2018  |
| Mega Man 11               | Nintendo Switch | 01 december 2018  |

In een ERD stellen we dit als volgt voor:

![](/img/databanken/Screenshot_from_2020-11-21_10-18-08.png)
