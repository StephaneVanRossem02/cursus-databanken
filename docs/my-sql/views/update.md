...
M.a.w. de [DML-commando's](/docs/my-sql/dml/) zijn ook hier te gebruiken (met bepaalde technische beperkingen).
...
We baseren ons op de view die we onder de rubriek [CREATE ](/docs/my-sql/views/create#voorbeeld)hebben aangemaakt. Deze gebruikt een `INNER JOIN`, maar dat verbiedt niet dat we updates doen.
