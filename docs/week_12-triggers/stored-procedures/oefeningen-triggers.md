...
Gebruik hierbij de `USER()`-functie\_.\_ Die geeft de naam van de verbonden gebruiker terug. Noem je script `0705__Oefening.sql`*.*
...
Noem je script `0706__Oefening.sql`*.*
