...
M.a.w. de [DML-commando's](/docs/week_01-basics/dml/) zijn ook hier te gebruiken (met bepaalde technische beperkingen).
...
We baseren ons op de view die we onder de rubriek [CREATE ](/docs/week_08-views-sp/views/create#voorbeeld)hebben aangemaakt. Deze gebruikt een `INNER JOIN`, maar dat verbiedt niet dat we updates doen.
...
![](/img/databanken/leden-taken-updatable-view.png)
