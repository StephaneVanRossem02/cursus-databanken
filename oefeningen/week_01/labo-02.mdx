---
title: Labo 02 - DDL
description: "DDL-oefeningen: maak zelf tabellen aan met passende datatypes en beperkingen, en pas ze achteraf aan. Oefen meteen in de SQL-sandbox in je browser."
sidebar_position: 3
slug: /labo-02
---
...
Zorg dat je code uitvoert en controleer dat je de tabellen (na refresh) ziet verschijnen.


<SqlSandbox labo="02" leeg />

<Modeloplossing labo="02">
...
Zorg dat je code uitvoert en controleer dat je de gegevens kan zien door op de knop naast de tabelnaam te klikken.
...
Verwijder de tabel `Huisdieren`, inclusief alle data, enkel en alleen met een geschreven instructie.
